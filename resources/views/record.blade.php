				...
				<div class="col-lg-10 col-xs-12"><center>
                   ...
                   <hr>
								<div class="row small-spacing">
									...
									<div class="col-lg-4 col-xs-10">
										<div class="form-group ">
											<label for="exampleInputEmail1">Time Interval/समय अंतराल: <h4 class="text-custom"><strong>{{$pass->tinterval}}</strong></h4></label>
                                    ...
                                    <div class="col-lg-4 col-xs-10">
										<div class="form-group ">
											<label for="exampleInputEmail1"><p class="text-danger"><strong>Status:  {{$pass->comment}}</strong></p></label>
